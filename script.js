function createCityList(citySearchList) {
  ...
  function populateCityWeather(city, citySearchList) {
    ...
    var queryURL =
      "https://api.openweathermap.org/data/2.5/weather?&units=imperial&appid=ea1461fdd67805068b968a92521ed4a7&q=" +
      city;
    var queryURL2 =
      "https://api.openweathermap.org/data/2.5/forecast?&units=imperial&appid=ea1461fdd67805068b968a92521ed4a7&q=" +
      city;
    var latitude;
    var longitude;
    $.ajax({
